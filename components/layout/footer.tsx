  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 32 20" className="h-5 w-auto" aria-hidden>
        ...
        <path
          d="M16 4.4a8 8 0 010 11.2 8 8 0 010-11.2z"
          fill="#FF5F00"
        />
      </svg>
    ),
...
export default function Footer() {
  ...
  return (
    <footer className="bg-stone-950 text-stone-400">
      ...
      <div className="border-b border-stone-800/80">
        <div className="mx-auto max-w-7xl px-4 py-12 lg:px-6">
          <div className="mb-6 flex items-end justify-between gap-4">
            ...
            <Link
              href="/search"
              className="hidden text-xs font-semibold text-orange-400 hover:text-orange-300 sm:block"
            >
              See all cities
            </Link>
          </div>
          ...
          <ul className="grid grid-cols-3 gap-3 sm:grid-cols-6">
            {CITY_TILES.map((city) => (
              <li key={city.name} className="group">
                <div className="relative aspect-square overflow-hidden rounded-2xl ring-1 ring-stone-800">
                  <Image
                    src={city.image}
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-5 px-4 py-8 md:flex-row md:items-center lg:px-6">
          ...
          <form className="flex w-full max-w-md gap-2">
            <input
              ...
              className="flex-1 rounded-xl border-0 bg-white/15 px-4 py-3 text-sm text-white placeholder-orange-100/80 outline-none ring-1 ring-white/30 backdrop-blur-sm focus:ring-white"
            />
            <button
              type="submit"
              className="rounded-xl bg-white px-5 py-3 text-sm font-bold text-orange-600 transition-transform hover:scale-105 active:scale-100"
            >
              Subscribe
            </button>
          </form>
      ...
      {/* Main footer */}
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 lg:grid-cols-12 lg:gap-8 lg:px-6">
        {/* Brand */}
        <div className="lg:col-span-4">
          <Link href="/" className="inline-flex items-center gap-2.5">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 text-white">
          ...
          <ul className="mt-6 space-y-2.5 text-sm">
            ...
            <li className="flex items-center gap-2.5 text-stone-400">
              ...
              <a href="mailto:hello@homelyx.in" className="hover:text-white">
                hello@homelyx.in
              </a>
            </li>
            <li className="flex items-center gap-2.5 text-stone-400">
          ...
          <div className="mt-6 flex gap-3">
            {[
              ...
              <a
                ...
                href="#"
                aria-label={s.label}
                className="flex h-9 w-9 items-center justify-center rounded-full bg-stone-800 text-stone-400 transition-colors hover:bg-orange-500 hover:text-white"
              >
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-6 lg:grid-cols-3">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/search" className="hover:text-orange-400">
                  Browse all
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/search/curries" className="hover:text-orange-400">
                  Curries
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/sell#how-it-works" className="hover:text-orange-400">
                  How it works
                </Link>
              </li>
              <li>
                <Link href="/sell#earnings" className="hover:text-orange-400">
                  Earnings calculator
                </Link>
              </li>
              <li>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-2">
            <a
              href="#"
              className="flex items-center gap-2 rounded-xl border border-stone-800 bg-stone-900 px-3 py-2.5 text-xs text-stone-300 transition-colors hover:border-orange-500/40 hover:text-white"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
                <path d="M3.6 2.7v18.6c0 .3.3.5.6.4l13-9.3c.3-.2.3-.6 0-.8l-13-9.3c-.3-.2-.6 0-.6.4z" />
              </svg>
              <div className="leading-tight">
                <p className="text-[10px] uppercase text-stone-500">Get it on</p>
          ...
          <div className="mt-5 flex items-center gap-2 rounded-xl border border-emerald-900/40 bg-emerald-950/40 px-3 py-2.5">
      ...
      <div className="border-t border-stone-800/80">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 text-xs text-stone-500 md:flex-row md:items-center lg:px-6">
          <p>&copy; {year} Homelyx Technologies Pvt. Ltd. All rights reserved.</p>
